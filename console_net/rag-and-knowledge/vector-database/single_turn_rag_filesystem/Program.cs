...
namespace single_turn_rag_filesystem
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Initializing store
            // LM-Kit.NET ships a built-in, file-system-based vector store: no external database or service is required.
            // Each collection is persisted as a ".ds" file in the chosen directory and reused across runs.
            string storeDirectory = Path.Combine(AppContext.BaseDirectory, "vector_store");
            _store = new FileSystemVectorStore(storeDirectory);
