...
- Support for multiple VLMs: PaddleOCR VL, GLM-OCR, GLM-V 4.6, LightOnOCR, MiniCPM, Qwen 3.5, Gemma 3, Ministral 3
...
- .NET 8.0 or later
- LM-Kit.NET SDK
- Sufficient VRAM for the selected model (1-18 GB depending on model choice)
