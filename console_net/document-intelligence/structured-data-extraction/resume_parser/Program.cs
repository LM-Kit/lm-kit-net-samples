...
namespace resume_parser
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine("Supports text, PDF, DOCX, and scanned resume images.");
            ...
            Console.WriteLine("7 - Alibaba Qwen 3.8 27B      (~18 GB VRAM)");
            ...
            Console.WriteLine("  <path>  - Parse a resume file (.txt, .pdf, .docx, .png, .jpg)");
